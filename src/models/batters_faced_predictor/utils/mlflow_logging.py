...
hit_predictor's / short_outing_predictor's utils/mlflow_logging.py (anchored
to this file's own location, so it "just works" once copied into a new
model directory — EXPERIMENT_NAME resolves to "batters_faced_predictor"
here). Not coupled to any hit_predictor-specific eval function; the caller
builds its own metrics dict.
"""
