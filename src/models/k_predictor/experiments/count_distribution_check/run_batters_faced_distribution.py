...
pitcher_starts_for_slots = pitcher_starts_for_slots.merge(schedule_teams, on="gamepk", how="left")
pitcher_starts_for_slots["opp_team_id"] = np.where(
    pitcher_starts_for_slots["pitcher_team_id"] == pitcher_starts_for_slots["home_id"],
    pitcher_starts_for_slots["away_id"], pitcher_starts_for_slots["home_id"],
)
...
starts_home_sp = pitcher_starts_for_slots[pitcher_starts_for_slots["pitcher_team_id"] == pitcher_starts_for_slots["home_id"]]
starts_away_sp = pitcher_starts_for_slots[pitcher_starts_for_slots["pitcher_team_id"] == pitcher_starts_for_slots["away_id"]]
